      ...
      <UCard class="md:col-span-2 bg-white dark:bg-[#0A1220] border-slate-200 dark:border-slate-800 relative overflow-hidden ring-1 ring-slate-200 dark:ring-slate-800 shadow-[0_0_15px_rgba(0,218,255,0.05)]">
        <div class="flex flex-col md:flex-row items-start md:items-center gap-6">
          <div class="h-24 w-24 rounded-full bg-cyan-500/10 flex items-center justify-center border border-cyan-500/30 flex-shrink-0 relative shadow-[0_0_20px_rgba(0,218,255,0.2)]">
            ...
            <div class="absolute -bottom-2 bg-cyan-500 text-white dark:text-[#050C16] text-xs font-bold px-2 py-0.5 rounded-full border-2 border-white dark:border-[#0A1220]">
              LVL 5
            </div>
          </div>
          <div class="flex-1 w-full relative z-10">
            ...
            <div class="flex items-center justify-between text-sm mb-2">
              <span class="font-bold text-cyan-400">450 <span class="text-slate-400 dark:text-slate-500">/ 500 XP</span></span>
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <UCard v-for="(mod, i) in modules" :key="i" 
          ...
          :class="{
            ...
            'ring-1 ring-cyan-500/30 dark:ring-cyan-500/50 shadow-[0_0_20px_rgba(0,218,255,0.1)] hover:shadow-[0_0_30px_rgba(0,218,255,0.2)] hover:-translate-y-1': !mod.locked && mod.progress > 0 && mod.progress < 100,
